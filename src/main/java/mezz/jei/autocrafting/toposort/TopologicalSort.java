...
package mezz.jei.autocrafting.toposort;
...
public final class TopologicalSort {
    ...
    public static <T> List<T> topologicalSort(ValueGraph<T, ?> graph, Comparator<? super T> comparator) throws IllegalArgumentException {
