...
public class GuiTextFieldFilterRecipes extends GuiTextField {
	...
	public GuiTextFieldFilterRecipes(int componentId, IRecipesGui recipesGui) {
	...
	public void update() {
		String filterText = recipesGui.getSearchFilter();
