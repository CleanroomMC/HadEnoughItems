...
public class RecipeRegistry implements IRecipeRegistry {
	...
	private final List<IRecipeCategory> recipeCategoriesVisibleCache = new ObjectArrayList<>();
	...
	private final List<RecipeRegistryPluginSafeWrapper> plugins = new ObjectArrayList<>();
